    ...
    <div class="row">
      <div class="col-5">
        <div class="card active">
          ...
          <div class="footer">
            <div class="imgWrap">
              <img src="<?php echo $zeplin ?>/main-2-nd-1-st-img.jpg" srcset="<?php echo $zeplin ?>/main-2-nd-1-st-img@2x.jpg 2x, <?php echo $zeplin ?>/main-2-nd-1-st-img@3x.jpg 3x">
            </div>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card">
          ...
          <div class="footer">
            <div class="imgWrap">
              <img src="<?php echo $zeplin ?>/4505.svg">
            </div>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card">
          ...
          <div class="footer">
            <div class="imgWrap">
              <img src="<?php echo $zeplin ?>/4506.svg">
            </div>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card">
          ...
          <div class="footer">
            <div class="imgWrap">
              <img src="<?php echo $zeplin ?>/5933.svg">
            </div>
          </div>
        </div>
      </div>
