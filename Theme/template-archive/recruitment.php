...
HTML;
          while ($custom_query->have_posts()) :
            ...
            $_permalink = get_field( "link_url", $post_ID );
            $_closed = get_field( "recruit_closed", $post_ID );
            ...
            if(!$_closed) :
              ...
              <div class="col-12 col-lg-6 col-xl-4 cardCol">
                <div class="rightCol">
                  <a href="$_permalink" class="thumbnail" target="_blank" style="background-image:url($_thumbnail);"></a>
              </div>
              <div class="leftCol">
                <div class="title">
                  <a href="$_permalink" target="_blank">$_title</a>
                </div>
...
HTML;
              ...
              $_thumbnail = '/wp-content/uploads/zeplin/thumb-recruit-closed.jpg';
              $renderTable .= <<<HTML
              <div class="col-12 col-lg-6 col-xl-4 cardCol">
                <div class="rightCol">
                  <div class="thumbnail" style="background-image:url($_thumbnail);"></div>
                </div>
                <div class="leftCol">
